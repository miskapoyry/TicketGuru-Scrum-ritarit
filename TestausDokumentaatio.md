...
| Feature                 | Skenaario                                          | Alkuasetelma                                                                                                    | Testi                                                                                                                               | Odotettu tulos                                                                                                                                                                                            | Status | Tarina                                        | Huomiot                                               |
|-------------------------|----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|-----------------------------------------------|-------------------------------------------------------|
...
| Tapahtumien tarkastelu  | Tapahtumien tarkastelu myynnin yhteydessä          | Käyttäjä on kirjautunut sisään                                                                                  | Käyttäjä klikkaa ""Sell tickets""                                                                                                   | Käyttäjä näkee listan tapahtumia. Näkyvillä tapahtuman nimi, päivämäärä, sijainti ja saatavilla olevien lippujen määrä.                                                                                   | PASS   | SR-29 Haluan löytää asiakkaille sopivat liput |                                                       |
| Tapahtumien haku        | Tapahtuman etsiminen nimellä                       | Käyttäjä on kirjautunut sisään                                                                                  | Käyttäjä kirjoittaa Search bariin tapahtuman alkukirjaimia ""art""                                                                  | Art Exhibition suodattuu heti tuloksista (vaikka kirjainkoko eri)                                                                                                                                         | PASS   | SR-29 Haluan löytää asiakkaille sopivat liput | Searchbar toimii vain adminilla, ei Salespersoneilla  |
...
| Lipun myynti            | Eri lipputyyppien myyminen samaan tapahtumaan      | Käyttäjä on valinnut haluamansa tapahtuman, johon on myynnissä erityyppisiä llippuja                            | Käyttäjä valitsee lippujen määrät kullekin tyypille (11 kpl Regular, 1 kpl VIP), valitsee maksutavan (tässä Cash) ja painaa Confirm | Proof of Sale -ikkuna avautuu, total tickets -määrä yhteensä 12.                                                                                                                                          | PASS   | SR-27 Haluan myydä ja tulostaa lippuja        |                                                       |
| Lipun tulostaminen      | Lipun tulostaminen                                 | Lippu on myyty = Confirm-nappia klikattu myyntitapahtumassa                                                     | Käyttäjä painaa ""Print""                                                                                                           | Selkeä qr-koodin sisältävä pdf-lippu avautuu                                                                                                                                                              | PASS   | SR-27 Haluan myydä ja tulostaa lippuja        |                                                       |
...
| Lipun tarkastus         | Lipun tarkastusyritys väärällä numerolla           | Käyttäjä on Validate Customer Tickets -näkymässä                                                                | Käyttäjä syöttää olemattoman lipun numeron                                                                                          | Käyttäjä saa virheviestin                                                                                                                                                                                 | PASS   | SR-28 Haluan tarkastaa liput                  |                                                       |
...
| Tapahtuman lisääminen   | Tapahtuman lisääminen menneeseen aikaan ei onnistu | Käyttäjä on avannut Create Event -lomakkeen                                                                     | Käyttäjä yrittää tallentaa tapahtumaa menneelle ajankohdalle                                                                        | Lisääminen ei onnistu                                                                                                                                                                                     | PASS   | SR-30 Haluan lisätä tapahtumia                | Tulee vain geneerinen virheviesti                     |
