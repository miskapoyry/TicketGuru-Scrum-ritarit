...
public class Event {
    ...
    public Event(AppUser appUser, String eventName, Timestamp eventDate, String location, int totalTickets, int availableTickets, List<EventTicketType> eventTicketTypes) {
